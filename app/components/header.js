...
const Header = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 bg-white overflow-auto w-full md:w-64 transition-all duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex justify-between items-center">
          <button onClick={toggleSidebar} className="text-gray-900 focus:outline-none left-0">
            <svg
