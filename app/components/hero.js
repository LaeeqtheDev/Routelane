  ...
  return (
    <div className="container mx-auto px-5 sm:px-10 lg:px-20 xl:px-32 flex flex-wrap p-5 items-center justify-between mt-14">
      <div className="flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 md:pr-6 mb-4 md:mb-0 text-center md:text-left">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-2">
            Streamlining <span className='text-4xl md:text-6xl lg:text-8xl text-[#4762FF]'>Trucking</span> Logistics
          </h1>
